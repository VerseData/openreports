...
{        
    ...
    //private static Logger log=(Logger) LogManager.getLoggerQuery(ReportTemplateResult.class);
    private static Logger log=(Logger) LogManager.getLogger(QueryReportTemplateResult.class);
